...
public class ViewBooks implements IOOperation {
	...
	public void oper(Database database, User user) {
		...
		String[] row1 = new String[] {"Name", "Author", "Publisher", "Address", "Quantity", "Price", "Bor. Copies"};
		for (String s : row1) {
		...
		for (Book b : database.getAllBooks()) {
			...
			JLabel label4 = label(b.getAddress());
			JLabel label5 = label(String.valueOf(b.getQuantity()));
